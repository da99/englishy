...
(function() {
  ...
  exports.Block = Block = (function() {
    ...
    Block.prototype.text_line = function(line_num) {
      ...
      return lines[target_i] || (function() {
  ...
  exports.Englishy = Englishy = (function() {
    ...
    Englishy.pair_to_tokens = function(pair, var_regexp) {
      var arr, block, i, line, line_arr, line_arr_w_empty_strings, piece, v, val, _i, _len;
      line = pair[0].replace(/[.:]$/, "");
      block = pair[1];
    ...
    Englishy.prototype.to_tokens = function(var_regexp) {
      ...
      tokens = (function() {
        ...
        for (_i = 0, _len = arr.length; _i < _len; _i++) {
          pair = arr[_i];
          _results.push(this.constructor.pair_to_tokens(pair, var_regexp));
        }
        return _results;
      }).call(this);
      return tokens;
