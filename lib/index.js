...
(function() {
  ...
  exports.Englishy = Englishy = (function() {
    ...
    Englishy.prototype._process_line = function(line) {
      var b, begins_with_whitespace, l;
      ...
      if (this.in_block()) {
        ...
        if (line.englishy('is_empty') && b.is_empty()) {
          return line;
        }
        if (b.is_empty() && line.englishy('is_empty') && l.englishy('is_empty')) {
          b.append_line(line);
          return line;
        }
        if (begins_with_whitespace || l.englishy('is_empty')) {
          b.append_line(line);
          return line;
        }
      }
      ...
      if (this.in_sentence()) {
        if (this.start_of_block(l)) {
          return this.record_error("Incomplete sentence before block: " + (this.lines.last()));
        }
    ...
    Englishy.prototype.parse = function() {
      ...
      if (this.lines.last && this.in_sentence()) {
        this.unknown_fragment(this.lines.last());
      }
      return this.lines;
    };
