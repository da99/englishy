...
(function() {
  ...
  Englishy = (function() {
    ...
    Englishy.prototype.Line = Line = (function() {
      ...
      Line.prototype.append = function(str) {
        return this.text = "" + (this.text()) + str;
      };
    ...
    Englishy.prototype.Block = Block = (function() {
      ...
      Block.prototype.is_whitespace = function() {
        return this.text().replace(this.regex.whitespace, '') === "";
      };
